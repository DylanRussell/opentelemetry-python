...
class TestBatchSpanProcessor(unittest.TestCase):
    ...
    def test_args_env_var(self):
        ...
        self.assertEqual(batch_span_processor._max_queue_size, 10)
        self.assertEqual(batch_span_processor._schedule_delay_millis, 2)
        self.assertEqual(batch_span_processor._max_export_batch_size, 3)
        self.assertEqual(batch_span_processor._export_timeout_millis, 4)
    ...
    def test_args_env_var_defaults(self):
        ...
        self.assertEqual(batch_span_processor._max_queue_size, 2048)
        self.assertEqual(batch_span_processor._schedule_delay_millis, 5000)
        self.assertEqual(batch_span_processor._max_export_batch_size, 512)
        self.assertEqual(batch_span_processor._export_timeout_millis, 30000)
